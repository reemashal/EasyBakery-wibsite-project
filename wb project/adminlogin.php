...
<ul>
   ...
   <body> 
	   ...
	   <h2 style="color:black;">Login as administrator</h2>				
       <p><input  class="input_login" name="admin_name" type="text"  placeholder="Admin name" value="" required></p> 
        <P><input  class="input_login" type="admin_password" name="pass" placeholder="Password" value="" required></P>
